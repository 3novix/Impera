...
<![CDATA[
  (function () {
    ...
    actors.actor_1 = { node: document.getElementById("SVG-Circus-fa77f5bc-24c6-645d-a6e9-2a494de3cdba").getElementById("actor_1"), type: "circle", cx: 50, cy: 50, dx: 70, dy: 17, opacity: 1.0 };
    ...
    tricks.trick_1 = function (_, t) {
     (t =
      ...
      (t = (t * 1) % 1),
      (t = 0 > t ? 1 + t : t);
     var a = (_.node, -36 * Math.cos((-90 * Math.PI) / 180)),
      i = 36 * Math.sin((-90 * Math.PI) / 180);
    ...
    tricks.trick_4 = function (_, t) {
     (t =
      ...
      (t = (t * 1) % 1),
      (t = 0 > t ? 1 + t : t);
     var a = (_.node, -44 * Math.cos((90 * Math.PI) / 180)),
      i = 44 * Math.sin((90 * Math.PI) / 180);
     (a += 44 * Math.cos(((90 - 360 * t * -1) * Math.PI) / 180)), (i -= 44 * Math.sin(((90 - 360 * t * -1) * Math.PI) / 180)), (_._tMatrix[4] += a), (_._tMatrix[5] += i);
    };
    var scenarios = {};
    scenarios.scenario_1 = { actors: ["actor_3"], tricks: [{ trick: "trick_1", start: 0, end: 1 }], startAfter: 0, duration: 1000, actorDelay: 0, repeat: 0, repeatDelay: 0 };
    scenarios.scenario_2 = { actors: ["actor_1"], tricks: [{ trick: "trick_2", start: 0, end: 1 }], startAfter: 0, duration: 3100, actorDelay: 0, repeat: 0, repeatDelay: 0 };
    scenarios.scenario_3 = { actors: ["actor_2"], tricks: [{ trick: "trick_3", start: 0, end: 1 }], startAfter: 0, duration: 1000, actorDelay: 0, repeat: 0, repeatDelay: 0 };
    scenarios.scenario_4 = { actors: ["actor_4"], tricks: [{ trick: "trick_4", start: 0, end: 1 }], startAfter: 0, duration: 2000, actorDelay: 0, repeat: 0, repeatDelay: 0 };
